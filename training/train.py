...
def perform_step(
    ...
    """
    # IDEA TO MODIFY: take the dict as input to perform_step instead of unpacking it before. Rest of the logic is identical, just remove the weights loss, it's useless
